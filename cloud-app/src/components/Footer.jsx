...
const Footer = () => {
  return (
    <div className='w-full mt-24 bg-slate-900 text-gray-300 py-8 px-2'>
        ...
        <div className='flex-col flex max-w-[1240px]  px-2 py-4 m-auto justify-between sm:flex-row text-center text-gray-500'>
            <p className='py-4'>2024 TEKLEDOPE. All rights reserved.</p>
